# Generated by Django 5.0.2 on 2024-04-12 03:35
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('vendor', '0006_alter_opening_hours_close_time_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='opening_hours',
            name='days',
            field=models.CharField(choices=[('1', 'SUNDAY'), ('2', 'MONDAY'), ('3', 'TUESDAY'), ('4', 'WEDNESDAY'), ('5', 'THURSDAY'), ('6', 'FRIDAY'), ('7', 'SATURDAY')], max_length=10),
        ),
        migrations.AlterField(
            model_name='opening_hours',
            name='open_time',
